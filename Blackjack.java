...
public class Blackjack {
    ...
    public static void printResult(Player dealer, Player user) {
        ...
        //If the user goes over 21, they lose the game
         if (user.getHandValue() > 21){
        ...
        //If the user and dealer both end up with the same value less than or equal to 21, 
        //the message “Push!"
        ...
        //decision about who won should be based on which player has the hand with higher value.
